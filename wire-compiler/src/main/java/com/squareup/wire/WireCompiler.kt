 ...
 * your classpath. If set, `custom_out` should also be provided and will pass to the factory's handler as a location
...
//      )
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            try {
                println("running wire compiler with args ${args.joinToString()}")
        ...
        fun forArgs(
            ...
            val protoPaths = mutableListOf<String>() // "/Applications/repo/wire-master/protos"
            var modules = mapOf<String, WireRun.Module>()
            var javaOut: String? = null
            var kotlinOut: String? = null // = "../wire-generated/src/main/java/"
            var swiftOut: String? = null // "swiftApp/networking-protobuf-generated/src/main/java"
                    ...
                    arg == KOTLIN_GRPC_SERVER_COMPATIBLE -> {
                        throw IllegalArgumentException(
                            "kotlin_grpc_server_compatible is no longer valid.\n" +
                                "Please migrate by following the steps defined in" +
                                "https://square.github.io/wire/wire_grpc/#wire-grpc-server",
                        )
                    }
