    ...
    override fun newHandler(): SchemaHandler {
        return object : SchemaHandler() {
            ...
            override fun handle(
                ...
                val swiftFile =
                    SwiftFileSpec.builder(typeName.moduleName, typeName.simpleName)
...
private class ClassNameSchemaHandlerFactory(
    ...
    private val delegate: SchemaHandler.Factory
        get() {
            ...
            val result =
                constructor.newInstance() as? SchemaHandler.Factory
