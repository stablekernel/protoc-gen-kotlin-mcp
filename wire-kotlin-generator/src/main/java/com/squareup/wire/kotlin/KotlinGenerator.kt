...
class KotlinGenerator private constructor(
    ...
    private fun generateMessage(type: MessageType): TypeSpec {
        ...
        val classBuilder =
            TypeSpec
                ...
                .apply {
                    ...
                    if (type.declaredFields.any { it.declaredJsonName == "_id" }) {
                        addSuperinterface(ClassName("com.cfahome.rex.ditto.support.model", "DittoDocumentTemplate"))
                    }
                }
        ...
        companionBuilder.addProperty(
            PropertySpec
                .builder("serialVersionUID", LONG, PRIVATE, CONST)
                .initializer("0L")
                .build(),
        )
    ...
    private fun generateCopyMethod(
        ...
        result.addParameter(
            ParameterSpec
                .builder("unknownFields", ByteString::class)
...
//    )
    ...
    private fun constructorParameterAndProperty(
        ...
        val isDittoId = field.declaredJsonName != null && field.declaredJsonName == "_id"
        ...
        if (isDittoId) {
            fieldClass = ClassName("com.cfahome.rex.ditto.support.model", "DittoDocumentIdentifier")
            fieldName = "_id"
        }

        val parameterSpec = ParameterSpec.builder(fieldName, fieldClass)
        if (!field.isRequired && !isDittoId) {
    ...
    companion object {
        ...
        private val BUILT_IN_TYPES =
            mapOf(
                ...
                ProtoType.INT64 to ClassName("com.cfahome.rex.common", "ProtobufLong"),
                ...
                ProtoType.DURATION to ClassName("com.cfahome.rex.common.time", "CommercePointNullableDuration"),
                ProtoType.TIMESTAMP to ClassName("com.cfahome.rex.common.time", "CommercePointNullableInstant"),
