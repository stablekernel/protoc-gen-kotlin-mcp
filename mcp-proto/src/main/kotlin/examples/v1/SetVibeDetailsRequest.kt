...
// Source: examples.v1.SetVibeDetailsRequest in example/v1/example.proto
package examples.v1
...
class SetVibeDetailsRequest(
  ...
  fun copy(vibe: String = this.vibe, vibe_scalar: VibeScalar? = this.vibe_scalar): SetVibeDetailsRequest = SetVibeDetailsRequest(vibe, vibe_scalar)
