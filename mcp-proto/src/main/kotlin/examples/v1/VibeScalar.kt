...
class VibeScalar(
    ...
    fun copy(
        ...
        VibeScalar(vibe_double, vibe_float, vibe_int32, vibe_int64, vibe_uint32, vibe_uint64, vibe_sint32, vibe_sint64, vibe_fixed32, vibe_fixed64, vibe_sfixed32, vibe_sfixed64, vibe_bool, vibe_bytes, vibe_enum)

    companion object {
        @JvmField
        val ADAPTER: ProtoAdapter<VibeScalar> =
            object : ProtoAdapter<VibeScalar>(
    ...
    enum class VibeEnum(
        ...
        companion object {
            @JvmField
            val ADAPTER: ProtoAdapter<VibeEnum> =
                object : EnumAdapter<VibeEnum>(
                    VibeEnum::class,
                    PROTO_3,
                    VibeEnum.VIBE_UNSET,
                ) {
            ...
            @JvmStatic
            fun fromValue(`value`: Int): VibeEnum? =
                when (`value`) {
                    0 -> VIBE_UNSET
                    1 -> VIBE_GOOD
                    else -> null
