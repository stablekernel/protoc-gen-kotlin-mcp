...
val service: McpVibeServiceClientImpl =
    McpVibeServiceClientImpl(
        client =
            GrpcVibeServiceClient(
                GrpcClient.Builder().client(
                    OkHttpClient().newBuilder().configureHttpClient().build(),
                ).baseUrl("http://localhost:2345").build(),
            ),
        mcpServer =
            Server(
                serverInfo =
...
fun OkHttpClient.Builder.configureHttpClient(): OkHttpClient.Builder =
    this
